...
export const metadata: Metadata = {
  title: 'ベビーノート',
  description: '育児・赤ちゃんの情報メディア',
  keywords: 'ベビーノート,育児・赤ちゃんの情報メディア',
  openGraph: {
    title: 'ベビーノート',
    description: '育児・赤ちゃんの情報メディア',
    type: 'website',
  ...
  return (
    <html lang="ja">
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html:`{"@context": "https://schema.org", "@type": "WebSite", "name": "ベビーノート", "description": "育児・赤ちゃんの情報メディア", "url": "https://baby-note-jp.vercel.app", "publisher": {"@type": "Organization", "name": "AOKAE合同会社", "url": "https://colorpass-web.vercel.app"}, "potentialAction": {"@type": "SearchAction", "target": "https://baby-note-jp.vercel.app/blog/{search_term_string}", "query-input": "required name=search_term_string"}}`}} />
      </head>
      <body>{children}
