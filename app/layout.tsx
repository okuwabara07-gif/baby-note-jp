...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'ベビーNOTE', description: 'ベビー用品・育児グッズの最新比較ランキング', siteName: 'K-Beauty Portal', type: 'website' },
  twitter: { card: 'summary_large_image', title: 'ベビーNOTE', description: 'ベビー用品・育児グッズの最新比較ランキング', site: '@beauty_note_j' },
};
